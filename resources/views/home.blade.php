...
<div class="h-12 w-full bg-gradient-to-b from-gray-50 to-white"></div>
  <div class="flex flex-col lg:flex-row h-full">
    ...
    <div class="relative w-full lg:w-1/2 h-96 lg:h-auto">
      ...
      <div class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/10 to-white"></div>
    </div>

    <!-- Konten di Kanan -->
    <div class="w-full lg:w-1/2 px-6 lg:px-12 py-12 flex flex-col justify-center z-10">
      <p class="text-blue-600 font-semibold mb-3 text-sm uppercase tracking-wide">
        Jangkau Pelanggan Baru lebih Luas
      </p>

      <h2 class="text-4xl lg:text-5xl font-bold text-navy-900 mb-6 leading-tight">
      Bangun Masa Depan Digital Bersama Kami
      </h2>
  ...
  <div class="h-12 w-full bg-gradient-to-b from-white to-gray-50"></div>
</section>
